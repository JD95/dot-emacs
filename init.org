...
(defun my-haskell-mode-delete-trailing-whitespace ()
...
(add-hook 'haskell-mode-hook
  (lambda ()
   ...
   (add-hook 'before-save-hook #'my-haskell-mode-delete-trailing-whitespace nil 'local)))
#+END_SRC
** html
...
(setq org-todo-keywords
  '((sequence
    "TODO(t)" "PROGRESSING(p)" "UNVERIFIED(u)" "DEVELOPING(v)" "HOLD(h)"
    "|" "DONE(d)" "VERIFIED(v)" "ANSWERED(a)" "FAILED(f)" "CANCELED(c)")))
#+END_SRC
